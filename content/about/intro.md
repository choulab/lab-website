...
The Chou lab develops artificial molecular devices for probing and manipulating biological systems and their activities. These devices are composed of engineered DNA and proteins that behave and interact according to user-specified rules and logics. We are interested in using these devices for both basic biology and medical applications, such as for biomarker discovery, personal diagnostics, and therapeutics. Our lab uses the tools of DNA nanotechnology, protein engineering, chemistry, molecular biology, and combines experimentation with computation. Students in the lab gain a broad spectrum of skills including molecular techniques, biochemistry, imaging, coding, device fabrication, and much more.<br>
