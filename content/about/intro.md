...
The Chou lab develops artificial molecules that enable precise determination and manipulation of biological structures and activities. These molecules are made from DNA and protein molecules that have been engineered by us to behave and interact with specific logics. We are interested in using these technologies for both basic biology and medical applications, such as for biomarker discovery, personal diagnostics, and therapeutics. Our lab uses the tools of DNA nanotechnology, protein engineering, chemistry, molecular biology, and combines experimentation with computation. Students in the lab gain a broad spectrum of skills including molecular techniques, biochemistry, imaging, coding, device fabrication, and much more.<br>
