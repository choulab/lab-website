...
The Chou lab develops programmable molecular technologies that enable precise determination and manipulation of biological structures and activities. These devices are composed of artificial DNA and protein molecules that behave and interact according to user-designed logic. We are interested in using these technologies for both basic biology and medical applications, such as for biomarker discovery, personal diagnostics, and therapeutics. Our lab uses the tools of DNA nanotechnology, protein engineering, chemistry, molecular biology, and combines experimentation with computation. Students in the lab gain a broad spectrum of skills including molecular techniques, biochemistry, imaging, coding, device fabrication, and much more.<br>
