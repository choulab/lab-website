...
The overarching question in our lab is to understand how nanoscale self-organization gives rise to function in biological systems. Currently, we study this in the context of membrane receptor signaling. These receptors represent the gateways by which cells sense their outside world and regulate important cell decisions such as replication, differentiation, and fate. We are interested in how these receptors self-organize to sense and compute external signals in order to mediate these processes. To this end, we create molecular technologies that allow us to study and manipulate membrane receptor interactions. Projects in the lab fall into one of three categories:
